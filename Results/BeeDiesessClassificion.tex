...
Arı hastalıklarının görüntü tabanlı tespitine yönelik çalışmalar son yıllarda hız kazanmaktadır. Altın vd.\ \cite{uzen2024}, ConvMixer, VGG16 ve ResNet101 sınıflandırıcılarını ortalama değer alma ile birleştiren bir topluluk öğrenme yaklaşımıyla BeeImage veri setinde \%98,87 F1 skoru elde etmiştir. Metlek ve Kayaalp \cite{metlek2021}, derin öğrenme yöntemleri ile arı sağlığının tespitini araştırmış; CNN tabanlı ÇKGB-YSA mimarisi \%94,25 ile üstün performans göstermiştir.

Varroa akarı tespitine odaklanan çalışmalar arasında Liu vd.\ \cite{liu2023}, segmentasyon ve nesne tespiti evrişimli sinir ağlarını birleştirerek Varroa bulaşını saptamıştır. Bilik vd.\ \cite{bilik2021}, nesne tespiti teknikleriyle görsel Varroa teşhisini araştırmıştır. Voudiotis vd.\ \cite{voudiotis2022} ise erken Varroa tespiti için derin öğrenme tabanlı bir kovan izleme sistemi geliştirmiştir.

VGG-19 mimarisini kullanan Kaplan Berkaya vd.\ \cite{kaplan2021} \%98,07 doğruluk ve \%94,19 F1 skoru bildirmiştir. Liang \cite{liang2024}, yapay zeka tabanlı entegre bir arı sağlığı değerlendirme sistemi önermiştir. Swin Transformer gibi modern Transformer tabanlı mimarilerin bu veri setinde hiç değerlendirilmemiş olması ve heterojen ensemble stratejilerinin yeterince araştırılmamış olması bu çalışmanın temel motivasyonunu oluşturmaktadır.
...
\midrule
CVR-TÖY \cite{uzen2024}                    &  --   & 98,87 \\
CNN+Softmax \cite{metlek2021}              & 92,70 & --    \\
CNN+ÇKGB-YSA \cite{metlek2021}             & 94,25 & --    \\
VGG-19 \cite{kaplan2021}                   & 98,07 & 94,19 \\
Liang \cite{liang2024}                     & 98,65 & --    \\
\midrule
...
Tablo~\ref{tab:ablation}, ensemble modelin bileşenlerinin performans üzerindeki etkisini göstermektedir.
...
\bibitem{uzen2024}
M.~Altın, H.~Üzen, and İ.~Balıkçı Çiçek, ``Bal arı hastalıklarının sınıflandırılması için ConvMixer, VGG16 ve ResNet101 tabanlı topluluk öğrenme yaklaşımı,'' \emph{Fırat Üniversitesi Mühendislik Bilimleri Dergisi}, cilt~36, sayı~1, ss.~133--145, 2024, doi: 10.35234/fumbd.1326290.
\newline \textit{Erişim linki:} \url{https://dergipark.org.tr/tr/download/article-file/3259284}

\bibitem{liu2023}
M.~Liu \emph{et~al.}, ``Detection of Varroa destructor infestation of honeybees based on segmentation and object detection convolutional neural networks,'' \emph{AgriEngineering}, vol.~5, no.~4, pp.~1644--1662, 2023, doi: 10.3390/agriengineering5040102.
\newline \textit{Erişim linki:} \url{https://doi.org/10.3390/agriengineering5040102}

\bibitem{metlek2021}
S.~Metlek and K.~Kayaalp, ``Derin öğrenme yöntemleri ile arıların sağlık durumunun tespit edilmesi,'' 2021.
\newline \textit{Erişim linki:} \url{https://www.researchgate.net/publication/351800252_Derin_Ogrenme_Yontemleri_ile_Arilarin_Saglik_Durumunun_Tespit_Edilmesi}

\bibitem{voudiotis2022}
G.~Voudiotis, A.~Moraiti, and S.~Kontogiannis, ``Deep learning beehive monitoring system for early detection of the Varroa mite,'' \emph{Signals}, vol.~3, no.~3, pp.~506--523, 2022, doi: 10.3390/signals3030030.
\newline \textit{Erişim linki:} \url{https://doi.org/10.3390/signals3030030}

\bibitem{bilik2021}
S.~Bilik \emph{et~al.}, ``Visual diagnosis of the Varroa destructor parasitic mite in honeybees using object detector techniques,'' \emph{Sensors}, vol.~21, no.~8, p.~2764, 2021, doi: 10.3390/s21082764.
\newline \textit{Erişim linki:} \url{https://doi.org/10.3390/s21082764}

\bibitem{kaplan2021}
S.~Kaplan~Berkaya, E.~Gündüz~Demir, and S.~Gunal, ``A vision-based bee identification approach using VGG-19,'' \emph{Ecological Informatics}, vol.~65, p.~101425, 2021, doi: 10.1016/j.ecoinf.2021.101425.
\newline \textit{Erişim linki:} \url{https://doi.org/10.1016/j.ecoinf.2021.101425}

\bibitem{liang2024}
A.~Liang, ``Developing an AI-based integrated system for bee health evaluation,'' arXiv preprint arXiv:2401.09988, 2024, doi: 10.48550/arXiv.2401.09988.
\newline \textit{Erişim linki:} \url{https://doi.org/10.48550/arXiv.2401.09988}

\bibitem{yang2018}
J.~Yang, ``BeeImage Dataset: Annotated Honey Bee Images from Video Footage,'' Harvard Dataverse, V1, 2018.
\newline \textit{Erişim linki:} \url{https://doi.org/10.7910/DVN/QQ6VVG}

\bibitem{tan2021}
M.~Tan and Q.~V.~Le, ``EfficientNetV2: Smaller models and faster training,'' in \emph{ICML}, 2021, pp.~10096--10106.
\newline \textit{Erişim linki:} \url{https://proceedings.mlr.press/v139/tan21a.html}

\bibitem{liu2021}
Z.~Liu \emph{et~al.}, ``Swin Transformer: Hierarchical vision transformer using shifted windows,'' in \emph{ICCV}, 2021, pp.~10012--10022.
\newline \textit{Erişim linki:} \url{https://openaccess.thecvf.com/content/ICCV2021/html/Liu_Swin_Transformer_Hierarchical_Vision_Transformer_Using_Shifted_Windows_ICCV_2021_paper.html}

\bibitem{selvaraju2017}
R.~R.~Selvaraju \emph{et~al.}, ``Grad-CAM: Visual explanations from deep networks,'' in \emph{ICCV}, 2017, pp.~618--626.
\newline \textit{Erişim linki:} \url{https://openaccess.thecvf.com/content_iccv_2017/html/Selvaraju_Grad-CAM_Visual_Explanations_ICCV_2017_paper.html}
