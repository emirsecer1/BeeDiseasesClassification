...
Arı hastalıklarının görüntü tabanlı tespitine yönelik çalışmalar son yıllarda giderek artmaktadır. Üzen vd.\ \cite{uzen2024}, ConvMixer, VGG16 ve ResNet101 sınıflandırıcılarını ortalama değer alma ile birleştiren bir topluluk öğrenme yaklaşımıyla BeeImage veri setinde \%98,87 F1 skoru elde etmiştir. Margapuri vd.\ \cite{margapuri2020}, transfer öğrenme yöntemiyle ResNet-50 kullanarak \%91,90 başarı oranı bildirmiştir.

Metlek ve Kayaalp \cite{metlek2021}, CNN tabanlı Softmax ve Çok Katmanlı Geri Beslemeli Yapay Sinir Ağı (ÇKGB-YSA) yaklaşımlarını karşılaştırmış; ÇKGB-YSA mimarisi \%94,25 ile üstün performans göstermiştir. Chawane vd.\ \cite{chawane2022}, DenseNet-121 modeliyle \%91,60 doğruluk elde etmiştir. Karthiga vd.\ \cite{karthiga2021} ise SMOTE veri dengeleme tekniğini CNN ile birleştirerek \%84,00 başarı oranına ulaşmıştır.

VGG-19 tabanlı çalışmalar arasında Liang \cite{liang2022} \%98,65 ile mevcut literatür rekorunu elde etmiştir. Yoo vd.\ \cite{yoo2023} \%94,50, Kılıç ve Yaman \cite{kilic2024} ise \%94,03 doğruluk bildirmiştir. Swin Transformer gibi modern Transformer tabanlı mimarilerin bu veri setinde hiç değerlendirilmemiş olması ve heterojen ensemble stratejilerinin yeterince araştırılmamış olması bu çalışmanın temel motivasyonunu oluşturmaktadır.
...
\bibitem{uzen2024}
H.~Üzen, M.~Altın, and İ.~Balıkçı Çiçek, ``Bal ar{\i} hastal{\i}klar{\i}n{\i}n s{\i}n{\i}fland{\i}r{\i}lmas{\i} için ConvMixer, VGG16 ve ResNet101 tabanl{\i} topluluk öğrenme yaklaşımı,'' \emph{F{\i}rat Üniversitesi Mühendislik Bilimleri Dergisi}, cilt~36, sayı~1, ss.~133--145, 2024, doi: 10.35234/fumbd.1326290.
...
\newline \textit{Erişim linki:} \url{https://scholar.google.com/scholar?q=Honey+bee+colony+and+varroa+mite+detection+using+deep+neural+networks}

\bibitem{metlek2021}
S.~Metlek and K.~Kayaalp, ``Arı hastalıklarının hibrit bir derin öğrenme yöntemi ile tespiti,'' \emph{Gazi Üniversitesi Mühendislik Mimarlık Fakültesi Dergisi}, cilt~36, sayı~3, ss.~1715--1732, 2021, doi: 10.17341/gazimmfd.749443.

\bibitem{chawane2022}
M.~Chawane, S.~Viriri, and M.~Gwetu, ``Bee disease identification using DenseNet-121,'' in \emph{ICAICV}, 2022, pp.~212--221.
\newline \textit{Erişim linki:} \url{https://scholar.google.com/scholar?q=Bee+disease+identification+using+DenseNet-121}
...
\newline \textit{Erişim linki:} \url{https://doi.org/10.1088/1742-6596/1767/1/012017}
...
\newline \textit{Erişim linki:} \url{https://doi.org/10.1155/2022/9415538}
...
\newline \textit{Erişim linki:} \url{https://doi.org/10.1016/j.compbiomed.2023.106579}
...
\newline \textit{Erişim linki:} \url{https://doi.org/10.1016/j.ecoinf.2024.102392}
