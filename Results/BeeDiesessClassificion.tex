...
\title{Classification of Honey Bee Diseases Using Image-Based Deep Learning: A Multi-Model Comparative Study}
...
\bibitem{uzen2019}
M.~Altın, H.~Üzen, and İ.~Balıkçı~Çiçek, ``Bal Arı Hastalıklarının Sınıflandırılması için ConvMixer, VGG16 ve ResNet101 Tabanlı Topluluk Öğrenme Yaklaşımı,'' \emph{Fırat Üniversitesi Mühendislik Bilimleri Dergisi}, vol.~36, no.~1, pp.~133--145, 2024, doi: 10.35234/fumbd.1326290. [Online]. Available: \url{https://dergipark.org.tr/tr/download/article-file/3259284}

\bibitem{margapuri2020}
M.~Liu \emph{et~al.}, ``Detection of Varroa destructor Infestation of Honeybees Based on Segmentation and Object Detection Convolutional Neural Networks,'' \emph{AgriEngineering}, vol.~5, no.~4, pp.~1644--1662, 2023, doi: 10.3390/agriengineering5040102. [Online]. Available: \url{https://doi.org/10.3390/agriengineering5040102}

\bibitem{metlek2021}
S.~Metlek and K.~Kayaalp, ``Derin Öğrenme Yöntemleri ile Arıların Sağlık Durumunun Tespit Edilmesi,'' 2021. [Online]. Available: \url{https://www.researchgate.net/publication/351800252_Derin_Ogrenme_Yontemleri_ile_Arilarin_Saglik_Durumunun_Tespit_Edilmesi}

\bibitem{chawane2022}
G.~Voudiots, A.~Meratli, and S.~Kontogiannis, ``Deep Learning Beehive Monitoring System for Early Detection of the Varroa Mite,'' \emph{Signals}, vol.~3, no.~3, pp.~506--523, 2022, doi: 10.3390/signals3030030. [Online]. Available: \url{https://doi.org/10.3390/signals3030030}

\bibitem{karthiga2021}
S.~Bilik \emph{et~al.}, ``Visual Diagnosis of the Varroa Destructor Parasitic Mite in Honeybees Using Object Detector Techniques,'' \emph{Sensors}, vol.~21, no.~8, p.~2764, Apr.~2021, doi: 10.3390/s21082764. [Online]. Available: \url{https://doi.org/10.3390/s21082764}

\bibitem{kaplan2021}
S.~Kaplan~Berkaya, E.~Gündüz~Demir, and S.~Gunal, ``A vision-based bee identification approach using VGG-19,'' \emph{Ecological Informatics}, vol.~65, p.~101425, 2021, doi: 10.1016/j.ecoinf.2021.101425. [Online]. Available: \url{https://doi.org/10.1016/j.ecoinf.2021.101425}

\bibitem{liang2022}
A.~Liang, ``Developing an AI-based Integrated System for Bee Health Evaluation,'' arXiv preprint arXiv:2401.09988, 2024, doi: 10.48550/arXiv.2401.09988. [Online]. Available: \url{https://doi.org/10.48550/arXiv.2401.09988}
